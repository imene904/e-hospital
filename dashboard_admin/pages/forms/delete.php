      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold"><?php  session_start();
                ...
                <div class="card-body">
                  ...
                  <form class="form-sample">
                    <p class="card-description">
                      ...
                      <select class="form-select bg-light border-0" style="height: 55px;" id="mail" name="mail">
                                        <option selected>Sélectionner Email</option>
                                        <?php try
                                                {
                      ...
                      <input type="submit" value="supprimer" class="btn btn-info btn-rounded btn-fw">
                    </div>
                  </div>
