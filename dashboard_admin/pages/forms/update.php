<?php
  ...
  $activ=1;
     if ($num2>0)
       ...
       {   $sql="update `patient` set  nom='$name',prenom='$prenom',num_tel='$email',adresse='$adresse',Email='$email',date_nais='$date_nais',mdp='$psw',cin='$nc',statut='$statut',role='$role' where Email='$email'";
