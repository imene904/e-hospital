...
<body>
 ...
 $r="patient";
    ...
    $query = "SELECT * FROM patient  where role='".$r."'";  
                    ...
                    <div class="row g-0 bg-light rounded overflow-hidden">
                                ...
                                <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                                    <div class="mt-auto p-4">
                                       ...
                                       <h8 class="d-inline-block text-primary text-uppercase border-bottom border-5"> Date de naissance : </h8> <p class="m-0"> <?php echo  $res->date_nais ;?> </p>
                                       <h8 class="d-inline-block text-primary text-uppercase border-bottom border-5"> N° tel : </h8><p class="m-0"> <?php echo  $res->num_tel ;?> </P>
                                   
                                    <a class="btn btn-primary w-100 py-3" href="#">plus des details</a>
